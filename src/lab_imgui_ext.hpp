...
inline ImFont * append_audio_icon_font(const std::vector<uint8_t> & buffer)
{
...
inline void DrawIcon(ImDrawList* drawList, const ImVec2& ul, const ImVec2& lr, IconType type, bool filled, ImU32 color, ImU32 innerColor)
{
    struct rectf {
        float x, y, w, h;
