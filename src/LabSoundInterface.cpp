...
namespace Sound {
    ...
    void Provider::pin_set_bus_from_file(entt::entity pin_id, const std::string& path)
    {
        entt::registry& registry = Registry();
    ...
    entt::entity Provider::connect_bus_out_to_bus_in(entt::entity output_node_id, entt::entity input_node_id)
    {
        entt::registry& registry = Registry();
    ...
    entt::entity Provider::connect_bus_out_to_param_in(entt::entity output_node_id, entt::entity pin_id)
    {
        entt::registry& registry = Registry();
    ...
    void Provider::disconnect(entt::entity connection_id)
    {
        entt::registry& registry = Registry();
    ...
    entt::entity Provider::create_runtime_context()
    {
        entt::registry& registry = Registry();
    ...
    void Provider::node_start_stop(entt::entity node_id, float when)
    {
        entt::registry& registry = Registry();
    ...
    void Provider::node_bang(entt::entity node_id)
    {
        entt::registry& registry = Registry();
        if (node_id == entt::null)
            return;
    ...
    entt::entity Provider::node_create(const std::string& name)
    {
        entt::registry& registry = Registry();
    ...
    void Provider::node_delete(entt::entity node_id)
    {
        entt::registry& registry = Registry();
    ...
    void Provider::pin_set_float_value(entt::entity pin, float v)
    {
        entt::registry& registry = Registry();
    ...
    void Provider::pin_set_int_value(entt::entity pin, int v)
    {
        entt::registry& registry = Registry();
        if (pin != entt::null && registry.valid(pin))
        {
    ...
    void  Provider::pin_set_bool_value(entt::entity pin, bool v)
    {
        entt::registry& registry = Registry();
        if (pin != entt::null && registry.valid(pin))
        {
    ...
    float Provider::node_get_timing_ms(entt::entity node)
    {
    ...
    float Provider::node_get_self_timing_ms(entt::entity node)
    {
        if (!registry().valid(node))
            return 0;
